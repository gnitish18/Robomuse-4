...
qtCreatorFile = "/home/nitish/catkin_ws/src/robomuse-ros-master/robomuse_drivers/scripts/robomuse_tele.ui" # Enter file here.
...
class MyApp(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.setupUi(self)
        self.exit.clicked.connect(self.func1)
